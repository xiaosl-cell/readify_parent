...
@Tag(name = "对话管理", description = "项目对话历史查询")
public class ConversationController {
    ...
    public Result<List<ConversationVO>> getConversationsByProjectId(
        ...
        List<ConversationVO> conversations = conversationService.getConversationsByProjectId(projectId, SecurityUtils.getCurrentUserId());
